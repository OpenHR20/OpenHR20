...
#define REVHIGH  3 //! Revision number high
#define REVLOW   1 //! Revision number low
#define REVSVN   5 //! Revision number revision
...
#define BOOT_DD         7  //!< Boot-Up date: day \todo move to CONFIG.H
#define BOOT_MM         2  //!< Boot-Up date: month \todo move to CONFIG.H
#define BOOT_YY         8  //!< Boot-Up date: year \todo move to CONFIG.H
#define BOOT_hh        22  //!< Boot-Up time: hour \todo move to CONFIG.H
#define BOOT_mm        29  //!< Boot-Up time: minutes \todo move to CONFIG.H
