...
#define REVLOW   82 //! Revision number low
#define VERSION_N 0xF082 //! Version as HEX value F0.82 (F as free)  

#ifndef REVISION
 #define REVISION "$Rev$"
#endif 
#define VERSION_STRING  "V: OpenHR20 SW version 0.82 build " __DATE__ " " __TIME__ " " REVISION
