...
#define REVLOW   94 //! Revision number low
#define VERSION_N 0xF094 //! Version as HEX value F0.92 (F as free)  

#ifndef REVISION
 #define REVISION "$Rev$"
#endif 
#define VERSION_STRING  "V: OpenHR20 SW version 0.94 build " __DATE__ " " __TIME__ " " REVISION
