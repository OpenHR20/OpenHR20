...
#define REVLOW   98 //! Revision number low
#define VERSION_N 0xF098 //! Version as HEX value F0.97 (F as free)  

#ifndef REVISION
 #define REVISION "$Rev$"
#endif 
#define VERSION_STRING  "V: OpenHR20 SW version 0.98 build " __DATE__ " " __TIME__ " " REVISION
