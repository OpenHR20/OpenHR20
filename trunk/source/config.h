...
#define REVLOW   81 //! Revision number low
#define VERSION_N 0xF081 //! Version as HEX value F0.81 (F as free)  

#ifndef REVISION
 #define REVISION "$Rev$"
#endif 
#define VERSION_STRING  "V: OpenHR20 SW version 0.81 build " __DATE__ " " __TIME__ " " REVISION
