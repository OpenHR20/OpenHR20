...
#define REVLOW   91 //! Revision number low
#define VERSION_N 0xF091 //! Version as HEX value F0.91 (F as free)  

#ifndef REVISION
 #define REVISION "$Rev$"
#endif 
#define VERSION_STRING  "V: OpenHR20 SW version 0.91 build " __DATE__ " " __TIME__ " " REVISION
