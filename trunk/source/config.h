...
#define REVLOW   90 //! Revision number low
#define VERSION_N 0xF090 //! Version as HEX value F0.90 (F as free)  

#ifndef REVISION
 #define REVISION "$Rev$"
#endif 
#define VERSION_STRING  "V: OpenHR20 SW version 0.90 build " __DATE__ " " __TIME__ " " REVISION
