...
#define REVLOW   95 //! Revision number low
#define VERSION_N 0xF095 //! Version as HEX value F0.95 (F as free)  

#ifndef REVISION
 #define REVISION "$Rev$"
#endif 
#define VERSION_STRING  "V: OpenHR20 SW version 0.95 build " __DATE__ " " __TIME__ " " REVISION
