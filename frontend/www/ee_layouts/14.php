...
$layout_ids_double = array (
    ...
    array( 'window_open_timeout','maximum time for window open state [minutes]'),
    ...
    array( 'afc_value' , 'afc correction value, binary complement for <0' ),
    array( 'afc_enable' , 'afc correction enable' ),
